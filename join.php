  ...
  <div class="container">
    <div class="button-group">
        <form id="join-form">
            ...
            <input id="channel" type="hidden" value="<?php echo $_POST['cname'];?>">
        ...
        <div class="wrapper">
            <img src="icon/close.svg" onclick="closeForm()">
                ...
                <div class="row-sm">
                    ...
                    <input id="channel" name="cname" type="text" placeholder="enter channel name" value="<?php echo $_POST['cname'];?>" required disabled>
                </div>
                <div class="row-sm">
                    <p class="join-info-text">ID</p>
                    <textarea name="token" id="token" cols="30" rows="5" placeholder="Room ID" required disabled><?php echo $_POST['token'];?></textarea>
                </div>
